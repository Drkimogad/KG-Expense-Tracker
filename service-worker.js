const CACHE_NAME = 'KG-Expense-Tracker-cache-v3'; // Update cache version
const urlsToCache = [
    ...
    'https://drkimogad.github.io/KG-Expense-Tracker/styles.css',
    'https://drkimogad.github.io/KG-Expense-Tracker/script.js',
    'https://drkimogad.github.io/KG-Expense-Tracker/manifest.json',
    'https://drkimogad.github.io/KG-Expense-Tracker/icons/icon-192x192.png',
    'https://drkimogad.github.io/KG-Expense-Tracker/icons/icon-512x512.png',
    'https://drkimogad.github.io/KG-Expense-Tracker/favicon.ico',
    'https://drkimogad.github.io/KG-Expense-Tracker/offline.html'     // Ensure offline page is cached
];
    ...
    event.respondWith(
        caches.match(event.request).then((cachedResponse) => {
            ...
            if (event.request.mode === 'navigate') {
                return caches.match('https://drkimogad.github.io/KG-Expense-Tracker/index.html');  // Ensure offline.html is cached
            }
            ...
            return caches.match('https://drkimogad.github.io/KG-Expense-Tracker/index.html');
        })
    );
});
